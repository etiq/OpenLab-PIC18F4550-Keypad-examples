 ...
 * Description          : Example_10.1 Keypad (PULL UP mode)
...
void GetKey(void)
 ...
 do
     ...
     while(1)
         {
        CTRL_PORT = 0X07;                                            /* 3rd bit of PORTD is reset                                                */
   ...
   CTRL_PORT = 0X0B;                                                /* 3rd bit of PORTD is reset                                                */
   ...
   CTRL_PORT = 0X0D;                                                /* 3rd bit of PORTD is reset                                                */
   ...
   if(Print_key(A20, arr[2][0]))
          ...
          break;
    CTRL_PORT = 0X0E;                                             /* 3rd bit of PORTD is reset                                                */
